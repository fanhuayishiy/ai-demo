...
void main() {
  ...
  <main class="experience">
    ...
    <footer class="attribution"><span>福州 · 三坊七巷</span><a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener noreferrer">© OpenStreetMap contributors</a><a class="attribution-detail" href="https://docs.overturemaps.org/attribution/" target="_blank" rel="noopener noreferrer">Overture · TopoExport</a><button data-action="sources">数据来源 ${Yt("info")}</button></footer>
