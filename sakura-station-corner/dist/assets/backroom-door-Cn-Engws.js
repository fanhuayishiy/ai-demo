import { g as grp, M as MAT, P as PAL, T as TEX, m as mesh, b as box, c as cyl, w as weather, h as decal, r as rbox, n as range, i as grill, a as sph, G as put, t as tor, p as shadowBlob, q as finish, z as rand } from './index-yWEMv7O8.js';
...
function build(options = {}) {
  ...
  closer.add(mesh(box(0.014, 0.010, 0.128), alu, { pos: [0.40, 0.028, 0.140], rot: [0, 0.70, -0.2] }));
  ...
  lever.add(mesh(cyl(0.014, 0.014, 0.062, 12), iron, { pos: [-5e-3, 0, 0.060], rot: [90 * D2R, 0, 0] }));
  ...
  lever.add(mesh(box(0.020, 0.006, 0.008), iron, { pos: [0, -0.125, -0.04] }));
  ...
  tag.add(noOut(mesh(cyl(0.0016, 0.0016, 0.05, 5), MAT.rubber('#7a746a'), { pos: [0.02, 0, -6e-3], rot: [0.3, 0, 0.2], cast: false })));
