import { g as grp, M as MAT, m as mesh, b as box, h as decal, T as TEX, c as cyl, w as weather, n as range, r as rbox, q as finish, z as rand } from './index-CxdYZv8e.js';
...
function build(options = {}) {
  ...
  for (let i = 0; i < bays; i++) {
    ...
    const pane = mesh(box(gw, gh, 0.012), M.glass, { name: 'glass-' + i, pos: [cx, gy, 0], cast: false, receive: false });
