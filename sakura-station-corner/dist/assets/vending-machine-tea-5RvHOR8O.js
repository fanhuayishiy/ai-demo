import { P as PAL, g as grp, M as MAT, T as TEX, m as mesh, b as box, A as row, r as rbox, i as grill, w as weather, H as plane, h as decal, c as cyl, a as sph, n as range, t as tor, W as pipe, q as finish, D as DoubleSide, z as rand, o as lathe } from './index-B1SzF3Mh.js';
...
function productTemplate(e) {
  ...
  if (e.kind === 'bottle') {
    ...
    p.add(noOut(mesh(latheOf([[R * 1.036, bs], [R * 1.022, bs + 0.006], [R * 1.036, (bs + be) * 0.5], [R * 1.022, be - 0.005], [R * 1.036, be]], 16),
      MAT.plastic('#ffffff', { graphic: true, map: labelTex(e), side: DoubleSide, spec: 0.24, sheen: 0.06, shadowAmt: 0.72 }))));
