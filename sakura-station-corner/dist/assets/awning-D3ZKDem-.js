import { g as grp, M as MAT, D as DoubleSide, P as PAL, m as mesh, r as rbox, n as range, b as box, c as cyl, w as weather, t as tor, K as extrude, J as shape, h as decal, T as TEX, k as tubeOf, q as finish, B as BufferGeometry, F as Float32BufferAttribute, z as rand, o as lathe } from './index-2XMcV6P5.js';
...
function build(options = {}) {
  ...
  for (const sx of [-1, 1]) {
    decal(bandG, {
      map: TEX.adStrip({ text: sx < 0 ? '春のさくら市 開催中' : '毎朝 6 時 パン・おにぎり入荷', bg: PAL.paintWarm, seed: seed + (sx < 0 ? 3 : 4) }),
