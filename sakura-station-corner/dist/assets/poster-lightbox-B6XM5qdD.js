import { g as grp, M as MAT, m as mesh, r as rbox, c as cyl, b as box, k as tubeOf, l as catenary, w as weather, h as decal, T as TEX, t as tor, q as finish, H as plane, D as DoubleSide, Y as memo, N as makeCanvas, z as rand, a7 as blotches, Q as toTexture, P as PAL, O as jpText, a5 as speckle } from './index-D433i3Qe.js';
...
function lightCase(w, h, seed, opts, dbl) {
  ...
  // 角めくれ（紙 1 枚浮く）
  const curl = noHull(mesh(plane(0.05, 0.05), MAT.paint('#ffffff', { map: springPosterTex(seed, opts.variant ?? 0), spec: 0.14, side: DoubleSide }), { pos: [(w - fw * 1.4) / 2 - 0.02, -(h - fw * 1.4) / 2 + 0.02, faceZ + 0.004], rot: [0.3, -0.4, 0.7], cast: false, receive: false }));
  c.add(curl);
  // 天側の排熱スリットとホコリ
