import { g as grp, M as MAT, m as mesh, b as box, c as cyl, h as decal, T as TEX, H as plane, w as weather, n as range, r as rbox, q as finish, z as rand } from './index-DD_JJZx9.js';
...
function build(options = {}) {
  ...
  for (const s of [-1, 1]) {
    ...
    // ガラス
    // ガラス：幕墙と同じく**平面 1 枚**。box + DoubleSide だと手前面と奥面が両方
    // 描かれて 1 葉で 2 層になり、建具の前だけ店内が白んだ。
    const pane = mesh(plane(leafW - 0.05, height - 0.2), M.glass, { pos: [0, y0 + height / 2, 0], cast: false });
