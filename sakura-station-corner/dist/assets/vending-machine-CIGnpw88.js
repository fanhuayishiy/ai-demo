import { P as PAL, g as grp, M as MAT, T as TEX, m as mesh, b as box, w as weather, h as decal, A as row, r as rbox, H as plane, c as cyl, i as grill, d as coil, W as pipe, D as DoubleSide, a as sph, q as finish, t as tor, z as rand, n as range, o as lathe } from './index-BqvI026L.js';
...
function productTemplate(e) {
  ...
  if (e.kind === 'pet' || e.kind === 'petsmall') {
    ...
    p.add(noOut(mesh(latheOf(sl, 18), MAT.plastic('#ffffff', { graphic: true, map: labelTex(e), side: DoubleSide, spec: 0.34, specPower: 70, sheen: 0.1, shadowAmt: 0.72, steps: 3 }), { pos: [0, 0, 0], name: 'pet-sleeve' })));
    ...
    p.add(noOut(mesh(latheOf([[R * 1.03, bs], [R * 1.02, bs + 0.008], [R * 1.032, (bs + be) * 0.5], [R * 1.02, be - 0.006], [R * 1.03, be]], 18),
      MAT.plastic('#ffffff', { graphic: true, map: labelTex(e), side: DoubleSide, spec: 0.32, sheen: 0.1, shadowAmt: 0.72 }))));
