...
> 在线演示：<https://fanhuayishiy.github.io/ai-demo/sakura-station-corner/dist/>（公网出画面 8.8～9.4 s，按窗口大小，本地 8.3 s）
...
在线演示直接点上面的链接（Pages 托管的是 `dist/`，无需构建，公网出画面 8.8～9.4 s，按窗口大小）。
