...
export const DEFAULT_OPTIONS = { kind: 'case', w: 0.7, seed: 12 };
...
export function build(options = {}) {
  ...
  lock.add(noOut(mesh(tubeOf([[0.014, -0.006, 0.004], [0.030, 0.000, -0.008], [0.036, 0.012, -0.020]], 0.0026, 10, 5), K.stainless)));
