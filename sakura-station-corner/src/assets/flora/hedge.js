...
import { grp, mesh, box, cyl, tor, plane, finish, rand, range, weather, inst } from '../../core/kit.js';
...
function stick(parent, from, to, r0, r1, mat, segs = 3, name = 'stick') {
  ...
  for (let i = 0; i < segs; i++) {
    ...
    const mm = mesh(cyl(rq(THREE.MathUtils.lerp(r0, r1, t1)), rq(THREE.MathUtils.lerp(r0, r1, t0)), rq((len / segs) * 1.15), 6), mat, { pos: [p.x, p.y, p.z], name });
