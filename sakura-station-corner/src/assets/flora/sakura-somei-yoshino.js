...
export const DEFAULT_OPTIONS = { seed: 11, height: 5.4, spread: 5.2, lean: 0, age: 1, style: 'open' };
  ...
  function blossom(parent, p, r, tier, opts = {}) {
    ...
    const puff = (host, rr0, nn, cwv, matv, pale, curl, spin0) => {
      host.add(inst(petalCard(q(cwv), q(cwv * 0.93), curl), matv, nn, (i, d, ru, col) => {
        ...
        const dir = new THREE.Vector3(Math.cos(az) * hrr, sy * (sy > 0 ? 1 : 0.74), Math.sin(az) * hrr).normalize();
