...
import {
  ...
  finish, rand, range, weather, decal, radial, catenary, d2r,
} from '../../core/kit.js';
...
export function build(options = {}) {
  ...
  radial(base, 4, 0.092, (i, a, x, z) => {
    ...
    b.add(mesh(cyl(0.0155, 0.0155, 0.006, 6), M.rust, { name: 'washer', pos: [0, -0.009, 0] }));
    return b;
  });
  // 台座の踏み板（タイヤを乗せる）
  ...
  foot.add(mesh(rbox(0.060, 0.010, 0.040, 0.003, 2), M.rubber, { name: 'heel-pad', pos: [-0.070, 0.012, 0.030] }));
  base.add(foot);
  ...
  GA.add(mesh(cyl(0.0100, 0.0100, 0.030, 10), M.steel, { name: 'gauge-stem', pos: [-0.020, -0.052, -0.006], rot: [d2r(18), 0, d2r(-18)] }));
  GA.add(mesh(rbox(0.030, 0.026, 0.030, 0.004, 2), M.barrelDark, { name: 'gauge-bracket', pos: [-0.026, -0.062, -0.010], rot: [0, d2r(14), d2r(10)] }));
  GA.add(mesh(tor(0.0108, 0.0022, 4, 12), M.rust, { name: 'gauge-joint', pos: [-0.028, -0.070, -0.010], rot: [d2r(70), 0, d2r(-18)] }));
  ...
  for (const sx of [-1, 1]) {
    AD.add(mesh(cyl(0.0060, 0.0060, 0.026, 8), M.bolt, { name: 'ad-bolt', pos: [sx * 0.100, -0.062, -0.006], rot: [Math.PI / 2, 0, 0] }));
  ...
  g.add(st);
  // 卷き上がった角
  st.add(mesh(rbox(0.016, 0.010, 0.0022, 0.001, 1), M.dial, { name: 'sticker-curl', pos: [0.024, -0.040, 0.004], rot: [d2r(-28), 0, d2r(14)] }));
  // ホコリ堆積（肩部・台座）
