...
import {
  grp, mesh, box, cyl, rbox, tor, lathe, tubeOf, coil, hoop, finish, rand,
  weather, decal, shadowBlob, rotY, sph,
} from '../../core/kit.js';
import { MAT } from '../../core/materials.js';
import { TEX, makeCanvas, toTexture, jpText, speckle } from '../../core/textures.js';
...
export const DEFAULT_OPTIONS = { seed: 7, height: 8.0, transformer: true, lampArm: false };
...
export function build(options = {}) {
  ...
  insulator(-0.70, prim[1].y - 0.104, { crack: false });
