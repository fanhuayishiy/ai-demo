...
import { grp, mesh, box, rbox, plane, rand, range, weather, decal } from '../../core/kit.js';
...
function curvedShell(w, h, t, curl, seed, sign = 1) {
  const g = new THREE.BoxGeometry(w, h, t, 9, 12, 1);
...
function oneMagazine(parent, variant, M, o, rnd, idx) {
  ...
  // ページ束（+X = 小口、-X = 背）
  g.add(noHull(mesh(new THREE.BoxGeometry(w * 0.972, h * 0.984, t * 0.9), [
