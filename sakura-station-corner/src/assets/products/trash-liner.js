...
import { grp, mesh, box, cyl, rbox, lathe, sph, tor, rand, range, weather } from '../../core/kit.js';
...
export function build(options = {}) {
  ...
  if (variant === 'pet-bottle') {
    ...
    const b = mesh(lathe(prof, 12), MAT.plastic('#e2b449', { spec: 0.34, specPower: 40, sheen: 0.05, side: THREE.DoubleSide }), { name: 'bag' });
